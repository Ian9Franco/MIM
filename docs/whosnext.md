...
- [ ] *No guardar la API key de Gemini en texto plano* (mim-settings.json + localStorage). Como mínimo cifrar en disco, o usar un keystore del SO (Electron tiene safeStorage).
