...
| ARCH-5 | web → apps/hub; eliminar duplicación semántica comprobada. | Build/deploy independientes, raíz/aliases/assets correctos y sin dependencias Desktop en browser. |
