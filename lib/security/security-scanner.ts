...
import { SUSPICIOUS_PATTERNS, OBFUSCATION_PATTERNS, KNOWN_MALWARE_HASHES, TRUSTED_MODS } from "@/lib/security/security-data";
import type { SecurityScanResult, SecurityFinding, ThreatCategory } from "@/lib/core/types";
