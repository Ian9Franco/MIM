...
| :--- | :--- | :--- |
| **Persistencia durable de Snapshots:** Backend en disco `FileSnapshotStore` (`ISnapshotStore`). Pendiente: recuperación de planes abiertos tras reinicio (T1.2) y cableado Desktop (T1.3). | `SRV-3` | 📘 [server-manager.md](./architecture/server-manager.md)<br/>📌 [ROADMAP.md (Sección 9)](./planning/ROADMAP.md#9-server-manager--sincronización-remota-issue-58--en-progreso) |
