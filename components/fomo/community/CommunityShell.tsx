    ...
    <div className="mb-4 shrink-0 px-4 pt-2">
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.07] bg-surface/75 px-4 py-3 shadow-[0_12px_34px_rgba(0,0,0,0.18)]">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/8 bg-white/4">
            ...
            >
              {selected && (
                <motion.span
                  ...
                  className="absolute inset-0 -z-10 rounded-lg border border-white/9 bg-white/8 shadow-[0_6px_18px_rgba(0,0,0,0.2)]"
