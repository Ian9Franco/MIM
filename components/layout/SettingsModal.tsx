              ...
              <div className="max-h-[350px] overflow-y-auto pr-2 space-y-6 scrollbar-thin">
                ...
                {activeTab === "apiKeys" && (
                  <div id="onboarding-settings-keys" className="space-y-5">
                    ...
                    <ApiKeyInputGroup label="CurseForge API Key" value={curseforgeApiKey} onChange={setCurseforgeApiKey} show={showCurseforge} onToggleShow={() => setShowCurseforge(!showCurseforge)} canEdit={canEdit} isValid={keyValidation.curseforge} isValidating={isValidatingKeys} saving={saving} configured={apiKeysConfigured.curseforgeApiKey} placeholder="Tu clave de CurseForge..." badge="Opcional" link="https://console.curseforge.com/" />
