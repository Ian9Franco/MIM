    ...
    <div className="space-y-6">
      ...
      {loadingFavorites ? (
        <div className="py-12 text-center text-white/40">
          <RefreshCw className="w-5 h-5 animate-spin mx-auto mb-2 text-primary" /> Cargando pool...
        </div>
      ) : filtered.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {displayFavs.map((fav) => {
                    ...
                    return (
                      <div
                        key={fav.id}
                        className="group rounded-2xl bg-white/4 border border-white/5 hover:border-primary/20 transition-all overflow-hidden flex flex-col"
                      >
                        <FomoModBannerStrip
