...
import { normalizeVersion, extractVersionFromFileName, extractMcVersionFromFileName, isValidImage } from "@/lib/mod-scanner/Utils";
...
import { ModMeta } from "@/lib/scanner";
