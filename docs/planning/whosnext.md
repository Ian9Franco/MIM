...
- [ ] **REC-02 — Reducir warnings de ESLint.** El techo Desktop bajó de 471 a 400 (medido: 392 warnings); el techo Hub bajó de 100 a 75 (medido: 69 warnings). Limpieza modular sin `eslint-disable` cosméticos. Corregidas variables muertas, optional catches e imports huérfanos.
