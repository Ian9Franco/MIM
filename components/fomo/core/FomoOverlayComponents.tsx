  ...
  return (
    <div className="px-5 py-6 border-b relative overflow-hidden group/header" style={{ background: "var(--fomo-secondary-bg)", borderColor: "var(--fomo-border)" }}>
      ...
      <div className="flex items-center gap-5 relative z-10">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button 
              ...
              className={`flex items-center justify-center h-7 px-3 rounded-lg text-[10px] font-black border transition-all ${
                communitySharedByMe ? "" : "hover:bg-white/20 bg-white/15 border-white/15 text-white/80"
              }`}
              style={
                communitySharedByMe
                  ? {
            ...
            {mod._source === "modrinth" && (
              <button 
                ...
                className={`flex items-center justify-center h-7 px-3 rounded-lg text-[10px] font-black border transition-all bg-white/15 border-white/15 text-white/80 hover:text-white`}
              >
        ...
        <button onClick={() => openExternal(mod.url)} className="p-3 rounded-2xl border border-white/15 bg-white/15 hover:bg-white/20 transition-all active:scale-95 group shrink-0">
