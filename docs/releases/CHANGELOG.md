...
## 🚀 Versión 13.0.3 — Release v13.0.3 — Sistemas y Criterio Técnico MIM (2026-09-25)

### Cambios incluidos

- Release v13.0.3 — Sistemas y Criterio Técnico MIM

---

## 🚀 Versión 13.0.2 — Release v13.0.2 — Sistemas y Criterio Técnico MIM (2026-09-23)
...
## 🚀 Versión 13.0.0 — Release v13.0.0 — Sistemas y Criterio Técnico MIM (2026-09-22)

### Cambios incluidos

- Release v13.0.0 — Sistemas y Criterio Técnico MIM
...
## 🚀 Versión 11.7.2 — FOMO UX y layout (2026-09-21)

- Versión visible en título y badge Beta; barra de progreso en el banner de actualización.
- Explorar por defecto: cualquier loader, cualquier versión, relevancia.
- Navbar FOMO con Explorar destacado; dependencias con «Volver al mod de origen».
- Fix versiones vacías en detalles y layout en pantallas 27".
- [Notas completas](./release-notes-v11.7.2.md).
...
## 🚀 Versión 11.5.0 — Release v11.5.0 — Sistemas y Criterio Técnico MIM (2026-09-19)
...
## 🚀 Versión 11.4.7 — Hotfix packaging Desktop (2026-09-13)

### Hotfix packaging Electron

- El instalable Windows vuelve a incluir `standalone/trusted-path.js` (v11.4.6 abría con `Cannot find module './trusted-path'`).
- Empaquetado de `standalone/*.js` completo + contrato CI para no omitir `require` locales.
