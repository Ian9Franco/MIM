...
| 1.3 Evaluación MimBot | Código: baseline `mimbot-fixtures.json` + `npm run eval:mimbot` + job live con umbrales SAGE-05b (pass rate/p95/wall). Confirmación con secrets de CI sigue operativa. |
