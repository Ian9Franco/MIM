...
import { ArrowLeft, Calendar, ChevronRight, Heart, Layers, Tv2, UserCheck } from "lucide-react";
...
export function CommunityPublicProfile({ profile, favorites, authors, drafts, channels, loading, onBack, onOpenMod, onSearchAuthor }: CommunityPublicProfileProps) {
