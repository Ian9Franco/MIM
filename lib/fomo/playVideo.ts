export { MAX_FLOATING_PLAYERS } from "@/lib/fomo/floatingPlayers";
...
/** Dispatch global floating-player open (desktop + hub). */
...
const CHROME_HEIGHT = 92; // header + seek + controls

/** Video viewport dimensions for mini / normal / maxi. */
