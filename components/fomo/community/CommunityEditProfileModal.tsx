...
export function CommunityEditProfileModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto animate-fade-in">
      <form 
        onSubmit={handleSubmit} 
        className={`border rounded-2xl p-6 w-full max-w-sm max-h-[calc(100vh-4rem)] overflow-y-auto space-y-4 shadow-2xl relative ${isModern ? 'bg-card text-foreground border-border shadow-[0_20px_60px_rgba(13,39,80,0.12)]' : 'bg-[#121214] border-white/10'}`}
      >
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          {(editAvatarUrl || rawImage) && (
            <button
              ...
              className="text-[9px] text-red-400 hover:text-red-300 flex items-center gap-1 mt-1 transition-all cursor-pointer bg-transparent border-none"
            >
        ...
        {/* Real-time Crop / Position Sliders */}
        {rawImage && (
