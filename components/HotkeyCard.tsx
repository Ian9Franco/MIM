...
export function HotkeyCard({ num, title, desc, icon, onClick, color = "wisteria" }: HotkeyCardProps) {
  ...
  const accentBg = isGold ? "rgba(255,208,102,0.07)" : "rgba(187,150,228,0.07)";
  const accentBorder = isGold ? "rgba(255,208,102,0.22)" : "rgba(187,150,228,0.22)";
  const hoverBorder  = isGold ? "rgba(255,208,102,0.45)" : "rgba(187,150,228,0.45)";
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        el.style.boxShadow = isGold
          ? "0 12px 32px rgba(255,208,102,0.10), 0 4px 16px rgba(0,0,0,0.15)"
    ...
    >
      ...
      <div
        ...
        style={{
          background: `color-mix(in srgb, ${isGold ? "#FFD066" : "#BB96E4"} 14%, transparent)`,
          border: `1px solid ${accentBorder}`,
          color: accent,
        }}
      >
      ...
      <div
        ...
        style={{
          background: isGold
            ? "linear-gradient(90deg, rgba(255,208,102,0.6) 0%, transparent 100%)"
